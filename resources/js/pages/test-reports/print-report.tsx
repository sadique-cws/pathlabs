...
export default function PrintReport({ sample, patient, parameters }: Props) {
    return (
        <>
                ...
                <div className="report-page mx-auto max-w-4xl  border border-slate-200 bg-white shadow-sm">
                    ...
                    <div className="border-b-2 border-[#147da2] px-8 py-6">
                        <div className="flex items-center justify-between">
                            <div>
                                <h2 className="text-2xl font-bold text-[#147da2]">Pathlog Diagnostics</h2>
                                <p className="mt-1 text-sm text-slate-500">NABL Accredited Laboratory</p>
                            </div>
                    ...
                    <div className="border-t-2 border-slate-300 px-8 py-6">
                        <div className="flex items-end justify-between">
                            <div className="text-xs text-slate-400">
                                <p>Generated by Pathlog Healthcare Management System</p>
