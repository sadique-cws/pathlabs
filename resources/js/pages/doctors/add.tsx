            ...
            <div className="min-h-full bg-slate-50/80 p-0">
                <div className="sawtooth border-b border-slate-200 bg-white p-6">
                    ...
                    >
                        ...
                        <input className="h-9 w-full  border border-slate-200 px-3 py-1.5 text-sm outline-none transition focus:border-[#147da2] focus:ring-1 focus:ring-[#147da2]/20" placeholder="Specialization" value={form.data.specialization} onChange={(e) => form.setData('specialization', e.target.value)} />
                        <input type="number" min={0} step="0.01" className="h-9 w-full  border border-slate-200 px-3 py-1.5 text-sm outline-none transition focus:border-[#147da2] focus:ring-1 focus:ring-[#147da2]/20" placeholder="Consultation Fee" value={form.data.consultation_fee} onChange={(e) => form.setData('consultation_fee', Number(e.target.value))} />
                        ...
                        <label className="md:col-span-2 flex items-center gap-2 text-sm text-slate-700">
                            <input type="checkbox" checked={form.data.can_approve_reports} onChange={(e) => form.setData('can_approve_reports', e.target.checked)} />
                            Can approve reports
                        </label>
