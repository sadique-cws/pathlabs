                    ...
                    >
                        <div className="space-y-4">
                            <div>
                                ...
                                <div className="grid grid-cols-1 xs:grid-cols-[120px_1fr] gap-2">
                                    ...
                                    <input className="h-9 rounded-md border border-slate-200 px-3 py-1.5 text-sm outline-none transition focus:border-[#147da2] focus:ring-1 focus:ring-[#147da2]/20" placeholder="Full Name" value={form.data.name} onChange={(e) => form.setData('name', e.target.value)} />
                                </div>
                            </div>

                            <div>
                                <label className="mb-1 block text-sm font-semibold text-slate-700">Age *</label>
                                <input type="number" min={0} className="h-9 w-full rounded-md border border-slate-200 px-3 py-1.5 text-sm outline-none transition focus:border-[#147da2] focus:ring-1 focus:ring-[#147da2]/20" placeholder="Age in years" value={form.data.age_years} onChange={(e) => form.setData('age_years', e.target.value)} />
                            </div>

                            <div>
                                <label className="mb-1 block text-sm font-semibold text-slate-700">Gender *</label>
                                <select className="h-9 w-full rounded-md border border-slate-200 px-3 py-1.5 text-sm outline-none transition focus:border-[#147da2] focus:ring-1 focus:ring-[#147da2]/20" value={form.data.gender} onChange={(e) => form.setData('gender', e.target.value)}>
                            ...
                            <div className="grid grid-cols-1 xs:grid-cols-2 gap-2">
                                ...
                                <div>
                                    ...
                                    <input className="h-9 w-full rounded-md border border-slate-200 px-3 py-1.5 text-sm outline-none transition focus:border-[#147da2] focus:ring-1 focus:ring-[#147da2]/20" placeholder="City" value={form.data.city} onChange={(e) => form.setData('city', e.target.value)} />
                                </div>
                            </div>

                            <div>
                                <label className="mb-1 block text-sm font-semibold text-slate-700">Local Area</label>
                                <input className="h-9 w-full rounded-md border border-slate-200 px-3 py-1.5 text-sm outline-none transition focus:border-[#147da2] focus:ring-1 focus:ring-[#147da2]/20" placeholder="Local Area" value={form.data.landmark} onChange={(e) => form.setData('landmark', e.target.value)} />
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <input className="h-9 w-full rounded-md border border-slate-200 px-3 py-1.5 text-sm outline-none transition focus:border-[#147da2] focus:ring-1 focus:ring-[#147da2]/20" placeholder="10-digit mobile number" value={form.data.phone} onChange={(e) => form.setData('phone', e.target.value)} />
                            </div>

                            <div>
                                <label className="mb-1 block text-sm font-semibold text-slate-700">Alternative Phone Number</label>
                                <input className="h-9 w-full rounded-md border border-slate-200 px-3 py-1.5 text-sm outline-none transition focus:border-[#147da2] focus:ring-1 focus:ring-[#147da2]/20" placeholder="10-digit alternative mobile number" value={form.data.alternative_phone} onChange={(e) => form.setData('alternative_phone', e.target.value)} />
                            </div>
                            ...
                            <div className="rounded-lg border border-slate-100 bg-slate-50/50 p-4">
                                ...
                                <div className="space-y-3">
                                    <div>
                                        ...
                                        <select className="h-9 w-full rounded-md border border-slate-200 px-3 py-1.5 text-sm outline-none transition focus:border-[#147da2] focus:ring-1 focus:ring-[#147da2]/20" value={form.data.discount_package} onChange={(e) => form.setData('discount_package', e.target.value)}>
                                    ...
                                    <div>
                                        ...
                                        <input type="date" className="h-9 w-full rounded-md border border-slate-200 px-3 py-1.5 text-sm outline-none transition focus:border-[#147da2] focus:ring-1 focus:ring-[#147da2]/20" value={form.data.discount_expiry_date} onChange={(e) => form.setData('discount_expiry_date', e.target.value)} />
                                    </div>
                                </div>
                            </div>
                        </div>
